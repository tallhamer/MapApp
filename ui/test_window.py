...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.w_hs_dicom_transparency = QSlider(self.groupBox_3)
        self.w_hs_dicom_transparency.setObjectName(u"w_hs_dicom_transparency")
        self.w_hs_dicom_transparency.setMaximum(100)
        self.w_hs_dicom_transparency.setValue(100)
        self.w_hs_dicom_transparency.setOrientation(Qt.Orientation.Horizontal)

        self.gridLayout_2.addWidget(self.w_hs_dicom_transparency, 3, 1, 1, 1)
        ...
        self.w_l_dicom_transparency = QLabel(self.groupBox_3)
        self.w_l_dicom_transparency.setObjectName(u"w_l_dicom_transparency")

        self.gridLayout_2.addWidget(self.w_l_dicom_transparency, 3, 2, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.w_l_dicom_transparency.setText(QCoreApplication.translate("MainWindow", u"100", None))
