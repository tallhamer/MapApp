...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.w_le_dcm_struct_file = QLineEdit(self.groupBox_3)
        ...
        self.w_pb_dcm_struct_file = QPushButton(self.groupBox_3)
        ...
        self.w_pb_dcm_plan_file = QPushButton(self.groupBox_3)
        ...
        self.w_le_dcm_plan_file = QLineEdit(self.groupBox_3)
        ...
        self.w_cb_dcm_color = QComboBox(self.groupBox_3)
        self.w_cb_dcm_color.setObjectName(u"w_cb_dcm_color")
        self.w_cb_dcm_color.setMinimumSize(QSize(100, 0))

        self.gridLayout_2.addWidget(self.w_cb_dcm_color, 2, 1, 1, 1)

        self.w_dcm_color_frame = QFrame(self.groupBox_3)
        ...
        self.gridLayout_2.addWidget(self.w_dcm_color_frame, 2, 2, 1, 1)
        ...
        self.w_hs_dcm_transparency = QSlider(self.groupBox_3)
        ...
        self.gridLayout_2.addWidget(self.w_hs_dcm_transparency, 3, 1, 1, 1)
        ...
        self.w_l_dcm_transparency = QLabel(self.groupBox_3)
        self.w_l_dcm_transparency.setObjectName(u"w_l_dcm_transparency")

        self.gridLayout_2.addWidget(self.w_l_dcm_transparency, 3, 2, 1, 1)
        ...
        self.w_hs_obj_transparency = QSlider(self.groupBox_4)
        ...
        self.gridLayout_3.addWidget(self.w_hs_obj_transparency, 2, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.w_pb_obj_file, 0, 3, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.w_cb_obj_color, 1, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.w_obj_color_frame, 1, 3, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.w_le_obj_file, 0, 2, 1, 1)

        self.w_l_obj_transparency = QLabel(self.groupBox_4)
        self.w_l_obj_transparency.setObjectName(u"w_l_obj_transparency")

        self.gridLayout_3.addWidget(self.w_l_obj_transparency, 2, 3, 1, 1)
