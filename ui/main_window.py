...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_4.addWidget(self.w_cb_body_structure, 4, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.w_tw_beams, 6, 0, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.w_l_patient_first_name, 1, 1, 1, 1)

        self.w_le_patinet_id = QLineEdit(self.groupBox_6)
        self.w_le_patinet_id.setObjectName(u"w_le_patinet_id")

        self.gridLayout_4.addWidget(self.w_le_patinet_id, 0, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.w_l_patient_last_name, 2, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.w_cb_plan_id, 3, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.w_gb_dicomrt_files, 8, 0, 1, 2)

        self.w_ch_use_dicomrt = QCheckBox(self.groupBox_6)
        self.w_ch_use_dicomrt.setObjectName(u"w_ch_use_dicomrt")

        self.gridLayout_4.addWidget(self.w_ch_use_dicomrt, 7, 0, 1, 2)
        ...
        self.w_dcm_color_frame = QFrame(self.groupBox_7)
        self.w_dcm_color_frame.setObjectName(u"w_dcm_color_frame")
        sizePolicy2 = QSizePolicy(QSizePolicy.Policy.Maximum, QSizePolicy.Policy.Maximum)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.w_dcm_color_frame.sizePolicy().hasHeightForWidth())
        self.w_dcm_color_frame.setSizePolicy(sizePolicy2)
        self.w_dcm_color_frame.setMaximumSize(QSize(25, 25))
        self.w_dcm_color_frame.setFrameShape(QFrame.Shape.StyledPanel)
        self.w_dcm_color_frame.setFrameShadow(QFrame.Shadow.Raised)

        self.gridLayout_7.addWidget(self.w_dcm_color_frame, 0, 2, 1, 1)
        ...
        self.w_cb_dcm_color = QComboBox(self.groupBox_7)
        self.w_cb_dcm_color.setObjectName(u"w_cb_dcm_color")
        self.w_cb_dcm_color.setMinimumSize(QSize(100, 0))

        self.gridLayout_7.addWidget(self.w_cb_dcm_color, 0, 1, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.w_hs_dcm_transparency, 2, 1, 1, 1)

        self.w_l_dcm_transparency = QLabel(self.groupBox_7)
        self.w_l_dcm_transparency.setObjectName(u"w_l_dcm_transparency")

        self.gridLayout_7.addWidget(self.w_l_dcm_transparency, 2, 2, 1, 1)
        ...
        self.w_cb_obj_color = QComboBox(self.groupBox_8)
        self.w_cb_obj_color.setObjectName(u"w_cb_obj_color")
        self.w_cb_obj_color.setMinimumSize(QSize(100, 0))

        self.gridLayout_5.addWidget(self.w_cb_obj_color, 1, 1, 1, 1)

        self.w_obj_color_frame = QFrame(self.groupBox_8)
        ...
        self.gridLayout_5.addWidget(self.w_obj_color_frame, 1, 2, 1, 1)
        ...
        self.w_background_color_frame = QFrame(self.groupBox_9)
        ...
        self.w_background_color_frame_2 = QFrame(self.w_background_color_frame)
        self.w_background_color_frame_2.setObjectName(u"w_background_color_frame_2")
        self.w_background_color_frame_2.setGeometry(QRect(0, 0, 25, 24))
        sizePolicy2.setHeightForWidth(self.w_background_color_frame_2.sizePolicy().hasHeightForWidth())
        self.w_background_color_frame_2.setSizePolicy(sizePolicy2)
        self.w_background_color_frame_2.setMinimumSize(QSize(0, 0))
        self.w_background_color_frame_2.setMaximumSize(QSize(25, 25))
        self.w_background_color_frame_2.setFrameShape(QFrame.Shape.StyledPanel)
        self.w_background_color_frame_2.setFrameShadow(QFrame.Shadow.Raised)

        self.gridLayout.addWidget(self.w_background_color_frame, 0, 2, 1, 1)

        self.w_cb_background_color = QComboBox(self.groupBox_9)
